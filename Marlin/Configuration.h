...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Creality Ender-3 Pro
  #define DEFAULT_bedKp 125.39
  #define DEFAULT_bedKi 21.43
  #define DEFAULT_bedKd 489.25
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 20, 25 } //AW
 ...
 */
#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN //AW
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -50, -8, -3 } //AW
...
#define XY_PROBE_SPEED 10000 //AW

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
// #define Z_PROBE_SPEED_FAST HOMING_FEEDRATE_MM_M[2]/2
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE   5 // Z Clearance for Deploy/Stow //AW
#define Z_CLEARANCE_BETWEEN_PROBES  4 // Z Clearance between probe points //AW
...
#define MIN_SOFTWARE_ENDSTOPS
  ...
  // #define MIN_SOFTWARE_ENDSTOP_Z //AW
#endif
...
#define AUTO_BED_LEVELING_BILINEAR //AW
...
#define HOMING_FEEDRATE_MM_M { (50*60), (50*60), (20*60) } //AW
